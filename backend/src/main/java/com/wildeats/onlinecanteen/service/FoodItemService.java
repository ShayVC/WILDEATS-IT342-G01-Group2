...
public class MenuItemService {
    ...
    @Autowired
    private MenuItemRepository foodItemRepo;
     ...
     */
    public List<MenuItemEntity> getAllFoodItems() {
     ...
     */
    public MenuItemEntity getFoodItemById(Long id) {
        logger.info("Fetching food item with ID: {}", id);
        Optional<MenuItemEntity> foodItem = foodItemRepo.findById(id);
     ...
     */
    public List<MenuItemEntity> getFoodItemsByShopId(Long shopId) {
     ...
     */
    public List<MenuItemEntity> getAvailableFoodItemsByShopId(Long shopId) {
     ...
     */
    public MenuItemEntity createFoodItem(FoodItemEntity foodItem, Long shopId) {
     ...
     */
    public MenuItemEntity updateFoodItem(MenuItemEntity foodItem) {
        logger.info("Updating food item with ID: {}", foodItem.getItemId());

        MenuItemEntity existingItem = getFoodItemById(foodItem.getItemId());
     ...
     * @return The updated food item
     */
    public MenuItemEntity updateFoodItemQuantity(Long itemId, int quantity) {
        logger.info("Updating quantity for food item with ID: {} to {}", itemId, quantity);

        MenuItemEntity foodItem = getFoodItemById(itemId);
        if (foodItem == null) {
     ...
     */
    public MenuItemEntity decreaseFoodItemQuantity(Long itemId, int amount) {
